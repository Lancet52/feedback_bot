...
@router_user_handlers.message(F.text)
...
@router_user_handlers.message(F.photo)
...
@router_user_handlers.message(F.video)
...
@router_user_handlers.message(F.animation)
...
@router_user_handlers.message(F.document)
